  ...
  * trim_final_newlines: Trim all newlines after the final newline at the end of the file.
  ...
  def schematic() do
    schema(__MODULE__, %{
      ...
      {"trimTrailingWhitespace", :trim_trailing_whitespace} => oneof([null(), bool()]),
      {"insertFinalNewline", :insert_final_newline} => oneof([null(), bool()]),
      {"trimFinalNewlines", :trim_final_newlines} => oneof([null(), bool()])
    })
  end
end
